...
EXECUTOR_REGISTRY: dict[str, ExecutorSpec] = {
    "cors_detector": ExecutorSpec(
        name="cors_detector",
        vuln_class="cors",
        module_path="demogorgon.executors.cors_detector",
    ...
    "jwt_attacker": ExecutorSpec(
        name="jwt_attacker",
        vuln_class="jwt",
        module_path="demogorgon.executors.jwt_attacker",
    ...
    "idor_tester": ExecutorSpec(
        name="idor_tester",
        vuln_class="idor",
        module_path="demogorgon.executors.idor_tester",
    ...
    "xss_detector": ExecutorSpec(
        name="xss_detector",
        vuln_class="xss",
        module_path="demogorgon.executors.xss_detector",
    ...
    "auth_bypass_tester": ExecutorSpec(
        ...
        module_path="demogorgon.executors.auth_bypass_tester",
    ...
    "ssrf_tester": ExecutorSpec(
        name="ssrf_tester",
        vuln_class="ssrf",
        module_path="demogorgon.executors.ssrf_tester",
    ...
    "race_detector": ExecutorSpec(
        name="race_detector",
        vuln_class="race",
        module_path="demogorgon.executors.race_detector",
    ...
    "info_disclosure_detector": ExecutorSpec(
        ...
        module_path="demogorgon.executors.info_disclosure_detector",
    ...
    "csrf_tester": ExecutorSpec(
        name="csrf_tester",
        vuln_class="csrf",
        module_path="demogorgon.executors.csrf_tester",
    ...
    "upload_tester": ExecutorSpec(
        ...
        module_path="demogorgon.executors.upload_tester",
    ...
    "ssti_detector": ExecutorSpec(
        name="ssti_detector",
        vuln_class="ssti",
        module_path="demogorgon.executors.ssti_detector",
    ...
    "xxe_detector": ExecutorSpec(
        name="xxe_detector",
        vuln_class="xxe",
        module_path="demogorgon.executors.xxe_detector",
    ...
    "redirect_tester": ExecutorSpec(
        ...
        module_path="demogorgon.executors.redirect_tester",
    ...
    "logic_tester": ExecutorSpec(
        ...
        module_path="demogorgon.executors.logic_tester",
