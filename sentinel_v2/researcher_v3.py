...
from sentinel_v2.controller.executive import ExecutiveController, Hypothesis
from sentinel_v2.controller.execution_graph import ExecutionGraph
from sentinel_v2.controller.self_evaluator import SelfEvaluator
from sentinel_v2.controller.tool_selection import get_executor_spec
from sentinel_v2.llm.manager import LLMManager
...
class ResearcherV3:
    ...
    async def start(self) -> dict[str, Any]:
        console.print(f"\n[bold green]Sentinel V3 — Autonomous Hunt on {self.target_url}[/bold green]\n")
