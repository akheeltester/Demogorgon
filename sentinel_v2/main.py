...
async def main():
    parser = argparse.ArgumentParser(description="Sentinel V2 — Autonomous Bug Bounty Hunter")
    ...
    if args.v3:
        from sentinel_v2.researcher_v3 import ResearcherV3
        ...
        from sentinel_v2.benchmark.runner import BenchmarkRunner
        from sentinel_v2.researcher_v3 import ResearcherV3
        ...
        from sentinel_v2.researcher import Researcher
        from sentinel_v2.llm_client import LLMClient
        ...
        try:
            ...
            if memory.findings:
                ...
                report_lines = [f"# Sentinel V2 Hunt Report\n"]
